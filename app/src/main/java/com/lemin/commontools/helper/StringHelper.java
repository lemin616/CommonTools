...
public class StringHelper {
     ...
     * @return
     */
    public static String resStr(int resId) {
     ...
     * @return
     */
    public static int resColor(int resId) {
     ...
     * @return
     */
    public static Drawable resDrawable(int resId) {
     ...
     * @return
     */
    public static String strFormat(int resId, Object... args) {
        return String.format(resStr(resId), args);
    }
     ...
     * 往图片添加数字
     */
    public static Bitmap setNumToIcon(int drawableId, int num) {
        BitmapDrawable bd = (BitmapDrawable) BaseApplication.instance()
