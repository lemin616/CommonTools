...
import com.lemin.commontools.base.BasePagerAdapter;
...
public class TabIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private void init(TypedArray a) {
        ...
        indicator_selected_color = a.getColor(R.styleable.TabIndicator_indicator_selected_color, Color.rgb(255, 87, 46));
        // indicator_normal_color
        indicator_normal_color = a.getColor(R.styleable.TabIndicator_indicator_normal_color, Color.rgb(112, 112, 112));
        ...
        tab_content.setBackgroundColor(Color.parseColor("#fafafb"));
     ...
     * @param adapter
     */
    public void setViewPage(BasePagerAdapter adapter) {
        viewPager = new ViewPager(getContext());
        viewPager.setId(R.id.vp);
        viewPager.setLayoutParams(new LinearLayoutCompat.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        viewPager.setAdapter(adapter);
