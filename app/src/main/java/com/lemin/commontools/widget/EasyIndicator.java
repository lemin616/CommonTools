...
public class EasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private void init(TypedArray a) {
        ...
        // indicator height
        indicatorHeight = (int) getDimensionPixelSize(a, R.styleable.TabIndicator_indicator_height, indicatorHeight);
        // indicator_bottom_height
        indicator_bottom_height = (int) getDimensionPixelSize(a, R.styleable.TabIndicator_indicator_bottom_height, indicator_bottom_height);
        // indicator_bottom_line_height
        indicator_bottom_line_height = (int) getDimensionPixelSize(a, R.styleable.TabIndicator_indicator_bottom_line_height, indicator_bottom_line_height);
        // indicator_bottom_line_color
        indicator_bottom_line_color = a.getColor(R.styleable.TabIndicator_indicator_bottom_line_color, Color.rgb(238, 238, 238));
        // indicator_selected_color
        indicator_selected_color = a.getColor(R.styleable.TabIndicator_indicator_selected_color, Color.rgb(253, 0, 0));
        // indicator_normal_color
        indicator_normal_color = a.getColor(R.styleable.TabIndicator_indicator_normal_color, Color.rgb(75, 75, 75));
        // indicator_line_color
        indicator_line_color = a.getColor(R.styleable.TabIndicator_indicator_line_color, Color.rgb(255, 87, 46));
        // indicator_textSize
        indicator_textSize = getDimensionPixelSize(a, R.styleable.TabIndicator_indicator_textSize, (int) indicator_textSize);
        // indicator_isBottom_line
        indicator_isBottom_line = a.getBoolean(R.styleable.TabIndicator_indicator_isBottom_line, indicator_isBottom_line);
        // indicator_vertical_line
        indicator_vertical_line_w = (int) getDimensionPixelSize(a, R.styleable.TabIndicator_indicator_vertical_line_w, indicator_vertical_line_w);
        // indicator_vertical_line_color
        indicator_vertical_line_color = a.getColor(R.styleable.TabIndicator_indicator_vertical_line_color, indicator_vertical_line_color);
        // indicator_vertical_line_h
        indicator_vertical_line_h = (int) getDimensionPixelSize(a, R.styleable.TabIndicator_indicator_vertical_line_h, indicator_vertical_line_h);
        // indicator_width
        indicator_width = (int) getDimensionPixelSize(a, R.styleable.TabIndicator_indicator_width, indicator_width);
        // indicator_select_textSize
        indicator_select_textSize = getDimensionPixelSize(a, R.styleable.TabIndicator_indicator_select_textSize, 14);
        ...
        for (int i = 0; i < tabTitles.length; i++) {
            ...
            switch (i) {
                case 0:
                    ...
                    view.setBackgroundDrawable(getResources().getDrawable(R.drawable.indicator_selected_corner));
                    break;
                default:
                    view.setTextColor(indicator_normal_color);
                    view.setTextSize(TypedValue.COMPLEX_UNIT_PX, indicator_textSize);
                    view.setBackgroundDrawable(getResources().getDrawable(R.drawable.indicator_normal_corner));
                    break;
            }
...
//        addView(line);
    ...
    private void setSelectorColor(TextView tv) {
        for (int i = 0; i < tvs.length; i++) {
            ...
            tvs[i].setBackgroundDrawable(getResources().getDrawable(R.drawable.indicator_normal_corner));
        }
        tv.setTextColor(indicator_selected_color);
        tv.setBackgroundDrawable(getResources().getDrawable(R.drawable.indicator_selected_corner));
